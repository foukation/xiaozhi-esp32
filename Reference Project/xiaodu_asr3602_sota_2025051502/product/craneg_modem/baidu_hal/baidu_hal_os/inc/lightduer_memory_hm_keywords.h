...
// Description: definition about the heap monitor module
    ...
    HM_KEYWORD(DUER_HM_PORT_UNISOC)
    HM_KEYWORD(DUER_HM_FLASH_STRINGS)
    HM_KEYWORD(DUER_HM_AUTO_DNS)
    HM_KEYWORD(DUER_HM_BDUSS_OAUTH)
    HM_KEYWORD(DUER_HM_CES)
    HM_KEYWORD(DUER_HM_CONNAGENT)
    HM_KEYWORD(DUER_HM_CONNAGENT_ADAPTER)
    ...
    HM_KEYWORD(DUER_HM_AUDIO_DECODER)
    HM_KEYWORD(DUER_HM_DLNA_RENDER)
    HM_KEYWORD(DUER_HM_APP)
    HM_KEYWORD(DUER_HM_MULTIPART_PARSER)
    HM_KEYWORD(DUER_HM_DLP)
    HM_KEYWORD(DUER_HM_THIRD_PARTY_MUSIC)
#else
