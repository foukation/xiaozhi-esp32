...
#define duer_ds_log_wifi_cfg(...)
#define duer_ds_log_wifi_cfg_start(...)
#define duer_ds_log_wifi_cfg_scan_results(...)
#define duer_ds_log_wifi_cfg_finished(...)
#define duer_ds_log_wifi_cfg_failed(...)
 ...
 * }
 */
duer_status_t duer_ds_log_wifi_cfg_scan_results(const char **ssids, duer_size_t num);
