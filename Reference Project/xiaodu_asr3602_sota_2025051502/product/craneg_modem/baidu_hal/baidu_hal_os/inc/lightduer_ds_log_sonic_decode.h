...
#define duer_ds_log_airkiss(...)
#define duer_ds_log_sonicdec_start(...)
#define duer_ds_log_sonicdec_audio_analysis(...)
#define duer_ds_log_sonicdec_fetched_start(...)
#define duer_ds_log_sonicdec_block_error(...)
#define duer_ds_log_sonicdec_fragment_fetched(...)
#define duer_ds_log_sonicdec_fragment_error(...)
#define duer_ds_log_sonicdec_frame_complete(...)
#define duer_ds_log_sonicdec_finish(...)
#define duer_ds_log_sonicdec_failed(...)
