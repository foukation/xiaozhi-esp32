...
#define duer_ds_log_ca(...)
#define duer_ds_log_ca_fatal(...)
#define duer_ds_log_ca_error(...)
#define duer_ds_log_ca_warn(...)
#define duer_ds_log_ca_info(...)
#define duer_ds_log_ca_debug(...)
#define duer_ds_log_ca_cache_error(...)
#define duer_ds_log_ca_start_state_change(...)
#define duer_ds_log_ca_start_connect(...)
#define duer_ds_log_ca_started(...)
#define duer_ds_log_ca_register_cp(...)
#define duer_ds_log_ca_call_cp(...)
#define duer_ds_log_ca_mbedtls_error(...)
#define duer_ds_log_ca_malloc_error(...)
