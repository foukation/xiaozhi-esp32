...
/**
 * DESC:
 * report when any alert has started (which means alert channel is active now).
 */
void duer_dcs_report_alerts_started();

/**
 * DESC:
 * report when all alerts have stopped playing (which means alert channel is not active now).
 */
void duer_dcs_report_alerts_stopped();

/**
 * DESC:
 * report when hourly chime started.
 */
void duer_dcs_report_hourly_chime_started();

/**
 * DESC:
 * report when hourly chime stopped or finished.
 */
void duer_dcs_report_hourly_chime_stopped();
