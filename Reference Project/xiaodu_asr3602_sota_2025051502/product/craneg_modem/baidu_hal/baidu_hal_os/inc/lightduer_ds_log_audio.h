...
#ifdef DUER_DISABLE_DS_LOG

#define duer_ds_log_audio(...)
#define duer_ds_log_audio_buffer_info(...)
#define duer_ds_log_audio_play_start(...)
#define duer_ds_log_audio_play_stop(...)
#define duer_ds_log_audio_play_finish(...)
#define duer_ds_log_audio_codec_version(...)
#define duer_ds_log_audio_info(...)
#define duer_ds_log_audio_m4a_head_size(...)
#define duer_ds_log_audio_content_type(...)
#define duer_ds_log_audio_download_delay(...)
#define duer_ds_log_audio_play_delay(...)
#define duer_ds_log_audio_memory_overflow(...)
#define duer_ds_log_audio_null_pointer(...)
#define duer_ds_log_audio_invalid_context(...)
#define duer_ds_log_audio_hls_parse_m3u8_error(...)
#define duer_ds_log_audio_framework_error(...)
#define duer_ds_log_audio_player_error(...)
#define duer_ds_log_audio_play_failed(...)
#define duer_ds_log_audio_user_defined_error(...)
#define duer_ds_log_audio_request_play(...)
#define duer_ds_log_audio_request_download(...)
