...
/*
 * Set encrypted or not.
 *
 * @Param hdlr, in, the context for the transport
 * @Param val, in, DUER_TRUE for encrypted socket.
 * @Return duer_status_t, the operation result
 */
DUER_INT_IMPL duer_status_t duer_trans_set_encrypted(duer_trans_handler hdlr,
                                                    duer_bool val);

/*
 * Disable verify ca chain.
 *
 * @Param hdlr, in, the context for the transport
 * @Return duer_status_t, the operation result
 */
DUER_INT_IMPL duer_status_t duer_trans_disable_verify_ca(duer_trans_handler hdlr);

/**
 * Set Application Layer protocol (ALPN) for TLS transport.
 */
DUER_INT duer_status_t duer_trans_set_alpn_protocol(duer_trans_handler hdlr,
                                                    duer_trans_alpn_protocol_t protocol);
