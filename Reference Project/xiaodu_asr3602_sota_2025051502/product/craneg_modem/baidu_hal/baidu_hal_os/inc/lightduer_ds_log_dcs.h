...
#define duer_ds_log_dcs(...)
#define duer_ds_log_dcs_report_with_dir(...)
#define duer_ds_log_dcs_directive_drop(...)
#define duer_ds_log_dcs_handler_unrealize(...)
#define duer_ds_log_dcs_add_directive_fail(...)
#define duer_ds_log_dcs_event_report_fail(...)
