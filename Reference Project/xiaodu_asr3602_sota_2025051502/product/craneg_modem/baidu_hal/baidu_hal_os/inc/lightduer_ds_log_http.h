...
#define duer_ds_log_http(...)
#define duer_ds_log_http_report_with_dir(...)
#define duer_ds_log_http_download_exit(...)
#define duer_ds_log_http_persisten_conn_timeout(...)
#define duer_ds_log_http_report_with_url(...)
#define duer_ds_log_http_report_err_code(...)
#define duer_ds_log_http_redirect_fail(...)
#define duer_ds_log_http_too_many_redirect(...)
