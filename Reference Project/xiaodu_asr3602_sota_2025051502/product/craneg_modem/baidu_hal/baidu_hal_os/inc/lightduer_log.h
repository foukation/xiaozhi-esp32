...
#define DUER_DEBUG_LEVEL 5
#endif

#if defined DUER_DEBUG_LEVEL
#if defined DUER_PLATFORM_UNISOC
#ifndef TRACE_INFO_SUPPORT // for unisoc
#undef DUER_DEBUG_LEVEL
#endif // TRACE_INFO_SUPPORT
#endif // DUER_PLATFORM_UNISOC
...
//defined as a weak function:__attribute__((weak)) void baidu_long_string_print(const chat* str)
void baidu_long_string_print(const char* str);
